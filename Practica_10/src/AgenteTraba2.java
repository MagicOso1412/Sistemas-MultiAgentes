...
public class AgenteTraba2 extends Agent {
    ...
    protected void setup() {
        System.out.println(getLocalName() + " Agente Traba2 Iniciado.");
        ...
        addBehaviour(new CyclicBehaviour() {
            ...
            public void action() {
                ...
                if (iteraciones >= 5) {
                    System.out.println("Traba2: Finalizando después de 5 iteraciones.");
                    myAgent.doDelete();
                    return;
                }
                ...
                if (mensaje != null) {
                    ...
                    System.out.println("Traba2: recibí -> " + contenido + " de " + emisor);
                    ...
                    if (contenido.equalsIgnoreCase("Enviar aptitud")) {
                        ...
                        System.out.println("Traba2: Aptitud = (2 * " + capacidad
                        ...
                        System.out.println("Traba2: Recibí tarea = 1. Ejecutando tarea...");
                    }
                }
            }
        });
