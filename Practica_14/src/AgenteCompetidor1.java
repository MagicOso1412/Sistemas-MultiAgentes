...
public class AgenteCompetidor1 extends Agent {
    ...
    protected void setup() {
        System.out.println("Competidor1 inicializado: " + getLocalName());
    ...
    private void manejarOfertasRivales(String[] partes) {
        ...
        if (ronda < 3) {
            if (ofertaActual < mayor) {
                // Nueva oferta aleatoria entre ofertaActual y 100
            ...
            // FASE 2: Enviar argumento solo una vez
            if (!argumentoEnviado) {
