...
public class AgenteJ2 extends Agent {
    private Random random = new Random();

    @Override
    protected void setup() {
        System.out.println("Jugador 2 iniciado: " + getLocalName());
            ...
            public void action() {
                ...
                if (msg != null) {
                    ...
                    if (contenido.equals("TU_TURNO")) {
                        ...
                        send(jugada);
                        System.out.println("J2 juega [" + fila + "," + col + "]");
                    } else if (contenido.equals("JUGADA_INVALIDA")) {
                        System.out.println("J2 hizo jugada inválida, intentando de nuevo...");
                        int fila = random.nextInt(3);
                        int col = random.nextInt(3);
                        ACLMessage jugada = new ACLMessage(ACLMessage.INFORM);
                        jugada.addReceiver(new AID("Arbitro", AID.ISLOCALNAME));
                        ...
                        System.out.println("J2: Empate. Fin del juego.");
                        doDelete();
                    } else if (contenido.startsWith("FIN_GANA")) {
                        System.out.println("J2: " + contenido);
                        doDelete();
                    }
                } else {
                    block();
